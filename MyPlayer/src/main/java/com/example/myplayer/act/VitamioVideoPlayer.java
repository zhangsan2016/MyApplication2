...
import com.example.myplayer.act.View.VitamioVideoView;
...
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
     ...
     * 是否使用系统监听卡
     */
    public boolean isUseSystem = false;
    /**
     * 上一次的播放进度
     */
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case PROGRESS:
                    ...
                    //  System.out.print("videoView.isPlaying() = " + videoView.isPlaying() + "  isUseSystem = " + isUseSystem);
    ...
    private void initData() {
        ...
        detector = new GestureDetector(this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                Toast.makeText(VitamioVideoPlayer.this, "长按方法", Toast.LENGTH_SHORT).show();
                startAndPause();
                super.onLongPress(e);
            }
            ...
            public boolean onDoubleTap(MotionEvent e) {
                Toast.makeText(VitamioVideoPlayer.this, "双击方法", Toast.LENGTH_SHORT).show();
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                Toast.makeText(VitamioVideoPlayer.this, "点击方法", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        videoView = (VitamioVideoView) this.findViewById(R.id.video_view);
