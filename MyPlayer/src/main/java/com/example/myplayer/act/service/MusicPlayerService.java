package com.example.myplayer.act.service;
...
public class MusicPlayerService extends Service {
    ...
    private void openAudio(int position) {
        ...
        if (mediaItems != null && mediaItems.size() > 0) {
            ...
            Toast.makeText(MusicPlayerService.this, "当前没有音乐数据！", Toast.LENGTH_SHORT).show();
        }
    ...
    private void start() {
        ...
        Notification notification = new Notification.Builder(this)
                ...
                .setContentText("当前播放：" + getName())
                .setContentTitle("My音乐播放器")
